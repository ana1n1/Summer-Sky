...
function preload() {
  ...
  https://www.instagram.com/amaro777/
  https://unsplash.com/@estebanamaro
  https://unsplash.com/photos/otE9jZe5RgM
  Free to use under the Unsplash License
  */
  img_front = loadImage(
    "./assets/esteban-amaro-front.png"
  );
  img_back = loadImage(
    "./assets/esteban-amaro-back.jpg"
  );
}
...
function generateGem() {
  ...
  gemsVertex.update = function () {
    ...
    if (round(centerVect.dist(this.position)) >= size / 1.6) {
...
function saveSouvenir() {
  ...
  saveCanvas(
    "Summer Sky Generator by Ana Gasharova - " + zeroNum(3, saveNum),
    "png"
  );
  resizeCanvas(size, (size * 5) / 4);
}
